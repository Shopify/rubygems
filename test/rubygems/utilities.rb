...
##
# A fake Gem::FakeBrowser is used in tests to mock a browser in that it can
# send HTTP requests to the defined URI.
#
# Example:
#
#   # Sends a get request to http://localhost:5678
#   Gem::FakeBrowser.get URI("http://localhost:5678")
#
# See RubyGems' tests for more examples of FakeBrowser.
#
