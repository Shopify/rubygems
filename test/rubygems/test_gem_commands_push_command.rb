...
class TestGemCommandsPushCommand < Gem::TestCase
  ...
  def test_otp_verified_success
    ...
    @fetcher.data["#{Gem.host}/api/v1/webauthn"] =
      HTTPResponseFactory.create(body: "You don't have any security devices", code: 403, msg: "OK")
  ...
  def test_webauthn_otp_verified_success
    webauthn_verification_url = "#{Gem.host}/api/v1/webauthn/odow34b93t6aPCdY"
    response_fail = "You have enabled multifactor authentication but your request doesn't have the correct OTP code. Please check it and retry."
    response_success = "Successfully registered gem: freewill (1.0.0)"
    ...
    @fetcher.data["#{Gem.host}/api/v1/webauthn"] = HTTPResponseFactory.create(body: webauthn_verification_url, code: 200, msg: "OK")
  ...
  def test_sending_gem_unathorized_api_key_with_mfa_enabled
    ...
    @fetcher.data["#{@host}/api/v1/webauthn"] =
      HTTPResponseFactory.create(body: "You don't have any security devices", code: 403, msg: "OK")
