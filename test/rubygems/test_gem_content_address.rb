...
class TestGemContentAddress < Gem::TestCase
  ...
  def test_file_name_claim_with_address_suffix
    assert_equal "abcdef12", Gem::ContentAddress.file_name_claim("a-1-abcdef12", util_claim_spec)
  end

  def test_file_name_claim_with_platform_suffix
    assert_nil Gem::ContentAddress.file_name_claim("a-1-x86_64-linux", util_claim_spec)
  end

  def test_file_name_claim_without_suffix
    assert_nil Gem::ContentAddress.file_name_claim("a-1", util_claim_spec)
  end

  def test_file_name_claim_with_hex_looking_original_platform
    spec = util_claim_spec platform: "deadbeef"
  ...
  def util_claim_spec(platform: "x86_64-linux")
    spec = Gem::Specification.new "a", 1
